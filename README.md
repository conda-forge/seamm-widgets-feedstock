...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/seamm-widgets-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/seamm-widgets-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add seamm-widgets
# for installing globally
pixi global install seamm-widgets
```
...
It is possible to list all of the versions of `seamm-widgets` available on your platform:
...
```
pixi search seamm-widgets --channel conda-forge
```
